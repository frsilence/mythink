<?php /*a:2:{s:69:"D:\wwwroot\mythink.test\mythink\resources\views\user\auth\create.html";i:1542895759;s:72:"D:\wwwroot\mythink.test\mythink\resources\views\user\layout\default.html";i:1542895421;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
...
<div class="col-md-offset-2 col-md-8">
    <div class="panel panel-default mt-5">
        ...
        <div class="panel-body">
            <form method="POST"
                  action="<?php echo url('user/auth/save'); ?>">
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">注册邮箱</span>
                    </div>
                    <input type="email"
                           class="form-control"
                           name="email">
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">密&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp码</span>
                    </div>
                    <input type="password"
                           class="form-control"
                           name="password">
